export const itIT = {
  ...
  projects: {
    ...
    deleteProjectLoading: "Caricamento anteprima eliminazione...",
  ...
  sources: {
    ...
    manageProjectsDesc: "Gestisci quali quaderni contengono questa fonte",
  ...
  share: {
    ...
    loading: "Caricamento chat condivisa...",
  ...
  apiKeys: {
    ...
    description: "Salva le chiavi API in modo sicuro nel database per abilitare i provider IA in Construction OS.",
