...
# The model name in Construction OS must be EXACTLY "gemma3:12b"
...
> **Tip:** This error often occurs when you delete a model from Ollama but forget to update the default models in Construction OS. Always re-configure defaults after removing models.
