export const zhTW = {
  ...
  sources: {
    ...
    noInsightsYet: "暫無見解",
    createFirstInsight: "使用上方的工件規則新增您的第一個見解",
    viewInsight: "查看見解",
    deleteInsight: "刪除見解",
  ...
  apiKeys: {
    ...
    description: "將 API 金鑰安全地儲存在資料庫中，以在 Construction OS 中啟用 AI 服務商。",
