export const ptBR = {
  ...
  projects: {
    ...
    deleteProjectLoading: "Carregando prévia da exclusão...",
  ...
  sources: {
    ...
    manageProjectsDesc: "Gerencie quais cadernos contêm esta fonte",
  ...
  apiKeys: {
    ...
    description: "Armazene chaves de API com segurança no banco de dados para habilitar provedores de IA no Construction OS.",
