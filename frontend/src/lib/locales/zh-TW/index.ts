export const zhTW = {
  ...
  "projects": {
    ...
    "deleteProjectNotes": "{count} 個工件將被永久刪除。",
    "deleteProjectNoNotes": "沒有可刪除的工件。",
    ...
    "artifactCreatedSuccess": "工件建立成功",
    "failedToCreateArtifact": "建立工件失敗",
    "artifactUpdatedSuccess": "工件更新成功",
    "failedToUpdateArtifact": "更新工件失敗",
    "artifactDeletedSuccess": "工件刪除成功",
    "failedToDeleteArtifact": "刪除工件失敗",
    "noteCreatedSuccess": "工件建立成功",
    "failedToCreateNote": "建立工件失敗",
    "noteUpdatedSuccess": "工件更新成功",
    "failedToUpdateNote": "更新工件失敗",
    "noteDeletedSuccess": "工件刪除成功",
    "failedToDeleteNote": "刪除工件失敗",
    "createNew": "新增專案",
  ...
  "sources": {
    ...
    "cannotSaveNoteNoProject": "無法儲存工件：專案 ID 不可用",
    ...
    "addTitle": "新增標題...",
    "untitledNote": "未命名工件",
    "writeNotePlaceholder": "在此處編寫您的工件內容...",
    "saveNote": "儲存工件",
    "createNoteBtn": "建立工件",
    "urlLabel": "URL(s) *",
    "fileLabel": "檔案(s) *",
  ...
  "chat": {
    "contextNoneSelected": "未選取上下文 — 切換來源或工件以將其包含在內。",
    "contextSearchPoolHelp": "所選來源/工件會在每則訊息中搜尋。聊天每次僅載入最相關的摘錄。",
    "contextFullSources": "{count} 個完整來源",
    "contextFullArtifacts": "{count} 個完整工件",
    "send": "Send",
    "queue": "Message queue",
  ...
  "podcasts": {
    ...
    "content": "內容",
    "contentDesc": "選擇要包含在此劇集中的專案、來源和工件。",
    ...
    "addContext": "新增上下文",
    "addContextDesc": "請至少選擇一個來源或工件以包含在劇集中。",
