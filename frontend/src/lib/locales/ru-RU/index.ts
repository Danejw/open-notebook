export const ruRU = {
  ...
  projects: {
    ...
    deleteProjectLoading: "Загрузка предварительного просмотра удаления...",
  ...
  sources: {
    ...
    manageProjectsDesc: "Управление блокнотами, содержащими этот источник",
  ...
  apiKeys: {
    ...
    description: "Храните API-ключи в базе данных для безопасного подключения провайдеров ИИ в Construction OS.",
