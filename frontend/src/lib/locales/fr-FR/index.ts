export const frFR = {
  ...
  projects: {
    ...
    deleteProjectLoading: "Chargement de l'aperçu de suppression...",
  ...
  sources: {
    ...
    createFirstInsight: "Créez votre premier aperçu en utilisant un artefact ci-dessus",
    ...
    manageProjectsDesc: "Gérer quels projets contiennent cette source",
  ...
  share: {
    ...
    loading: "Chargement du chat partage...",
  ...
  apiKeys: {
    ...
    description: "Stockez les clés API de manière sécurisée dans la base de données pour activer les fournisseurs d'IA dans Construction OS.",
