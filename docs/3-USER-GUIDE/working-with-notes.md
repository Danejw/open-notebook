...
6. Click "Save"
7. Done! Note appears in your project
```

### Method 3: Apply Artifact
...
### 3. Artifacts (Batch Processing)

```
Workflow:
  Define artifact → Apply to sources → Notes auto-created
...
Construction OS comes with presets:
...
6. New notes appear in your project
7. Edit if needed
```
...
```
1. Click "Create Custom Artifact"
...
## Organizing Your Project's Notes
...
1. Generate podcast for project
...
|---------|---------|----------|
| Save every Chat response | Project becomes cluttered with low-quality notes | Only save good responses that answer your questions |
