...
| **[Native tools](tools/extending.md)** | Protocol-neutral Cos capabilities bound into project chat (`native__*`) | [extending.md](tools/extending.md) · [catalog](tools/catalog.md) · [architecture](tools/architecture.md) |
