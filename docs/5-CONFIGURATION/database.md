...
Construction OS uses SurrealDB for its database needs. 

---

## Default Configuration

Construction OS should work out of the box with SurrealDB as long as the environment variables are correctly setup. 


### DB running in the same docker compose as Construction OS (recommended)
...
### DB running in the host machine and Construction OS running in Docker
...
### Construction OS and Surreal are running on the same machine
