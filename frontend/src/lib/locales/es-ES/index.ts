export const esES = {
  ...
  "common": {
    ...
    "saveToNote": "Guardar en artefacto",
    ...
    "accessibility": {
      "artifactViews": "Vistas de transformación",
      ...
      "searchProjects": "Buscar cuadernos"
    },
    "url": "URL",
    "errorDetails": "Detalles del error",
    "editArtifact": "Editar transformación",
    "retry": "Reintentar",
  ...
  "apiErrors": {
    ...
    "artifactNotFound": "Artefacto no encontrada",
  ...
  "connectionErrors": {
    ...
    "apiDesc": "No se pudo alcanzar el servidor API de Construction OS",
    ...
    "docLink": "Documentación de Construction OS",
  ...
  "navigation": {
    ...
    "podcasts": "Podcasts",
    "models": "Modelos",
    "artifacts": "Plantillas de artefacto",
    "images": "Images",
    "templates": "Templates",
    "skills": "Skills",
    "tools": "Tools",
  ...
  "projects": {
    ...
    "deleteProject": "Eliminar cuaderno",
    "deleteProjectDesc": "¿Estás seguro de que quieres eliminar \"{name}\"? Esta acción no se puede deshacer.",
    "deleteProjectNotes": "{count} artefacto(s) se eliminarán permanentemente.",
    "deleteProjectNoNotes": "No hay artefactos para eliminar.",
    "deleteProjectExclusiveSources": "{count} fuente(s) existen solo en este cuaderno.",
    "deleteProjectSharedSources": "{count} fuente(s) son compartidas con otros cuadernos y serán desvinculadas.",
    ...
    "exportPdfSuccess": "Artefacto exportado como PDF",
    "exportMarkdownSuccess": "Artefacto exportado como Markdown",
    "failedToExportPdf": "Error al exportar el artefacto como PDF",
    "failedToExportMarkdown": "Error al exportar el artefacto como Markdown",
    "artifactCreatedSuccess": "Artefacto creado correctamente",
    "failedToCreateArtifact": "No se pudo crear el artefacto",
    "artifactUpdatedSuccess": "Artefacto actualizado correctamente",
    "failedToUpdateArtifact": "No se pudo actualizar el artefacto",
    "artifactDeletedSuccess": "Artefacto eliminado correctamente",
    "failedToDeleteArtifact": "No se pudo eliminar el artefacto",
    "noteCreatedSuccess": "Artefacto creado correctamente",
    "failedToCreateNote": "No se pudo crear el artefacto",
    "noteUpdatedSuccess": "Artefacto actualizado correctamente",
    "failedToUpdateNote": "No se pudo actualizar el artefacto",
    "noteDeletedSuccess": "Artefacto eliminado correctamente",
    "failedToDeleteNote": "No se pudo eliminar el artefacto",
  ...
  "sources": {
    ...
    "cannotSaveNoteNoProject": "No se puede guardar el artefacto: ID del proyecto no disponible",
    ...
    "sourcesAddedToProject": "{count} fuente(s) agregadas al cuaderno",
    "failedToAddSourcesToProject": "Error al agregar fuentes al cuaderno",
    "partialAddSuccess": "{success} fuente(s) agregadas, {failed} fallaron",
    "sourceRemovedFromProject": "Fuente eliminada del cuaderno exitosamente",
    "failedToRemoveSourceFromProject": "Error al eliminar la fuente del cuaderno",
    ...
    "dropArtifactHint": "Suelta una plantilla aquí para añadir una nueva fuente",
    "dropArtifactNoteHint": "Suelta el artefacto aquí para ingerirlo como fuente",
    "dropArtifactOnSource": "Suelta para ejecutar la plantilla en esta fuente",
    "dragTemplateToSource": "O arrastra una plantilla desde Artifacts a una fuente.",
    "editNote": "Editar artefacto",
    "createNote": "Crear artefacto",
    "addTitle": "Agregar un título...",
    "untitledNote": "Artefacto sin título",
    "writeNotePlaceholder": "Escribe el contenido de tu artefacto aquí...",
    "saveNote": "Guardar Artefacto",
    "createNoteBtn": "Crear Artefacto",
    "urlLabel": "URL(s) *",
    "fileLabel": "Archivo(s) *",
    ...
    "manageProjects": "Gestionar cuadernos",
    "noProjectsAvailable": "No hay cuadernos disponibles",
    "loadFailed": "Error al cargar los detalles de la fuente",
    "removeFromProject": "Quitar del cuaderno",
    ...
    "retry": "Reintentar",
    "failureDetailsUnavailable": "Los detalles de diagnóstico no están disponibles para este fallo anterior.",
    ...
    "noProjectsFound": "No se encontraron cuadernos.",
  ...
  "chat": {
    "contextNoneSelected": "No hay contexto seleccionado — activa fuentes o artefactos para incluirlos.",
    "contextSearchPoolHelp": "Las fuentes/artefactos seleccionados se buscan en cada mensaje. El chat carga solo los extractos más relevantes cada vez.",
    "contextFullSources": "{count} fuente(s) completa(s)",
    "contextFullArtifacts": "{count} artefacto(s) completo(s)",
    "send": "Send",
    "queue": "Message queue",
    ...
    "chatWithProject": "Chat con cuaderno",
  ...
  "searchPage": {
    ...
    "ask": "Preguntar",
    "processing": "Procesando...",
    "saveToProjects": "Guardar en cuadernos",
  ...
  "podcasts": {
    ...
    "content": "Contenido",
    "contentDesc": "Elige proyectos, fuentes y artefactos para incluir en este episodio.",
    "itemsSelected": "{count} elementos seleccionados",
    "tokens": "{count} tokens",
    "chars": "{count} caracteres",
    "loadingProjects": "Cargando cuadernos...",
    "noProjectsFoundInPodcasts": "No se encontraron cuadernos. Crea un cuaderno y agrega contenido antes de generar un podcast.",
    ...
    "addContextDesc": "Selecciona al menos una fuente o artefacto para incluir en el episodio.",
    ...
    "noNotes": "No hay artefactos disponibles en este proyecto.",
    ...
    "setupRequiredDesc": "Algunos perfiles aún no tienen modelos configurados. Edítalos para seleccionar modelos antes de generar podcasts.",
  ...
  "settings": {
    ...
    "filesHelp": "Una vez que tus archivos se suben y procesan, ya no son necesarios. La mayoría de los usuarios deberían permitir que Construction OS elimine los archivos subidos de la carpeta de carga automáticamente.",
  ...
  "advanced": {
    ...
    "updateAvailableDesc": "Una nueva versión de Construction OS está disponible.",
  ...
  "artifacts": {
    ...
    "listTitle": "Artefactos personalizadas",
    ...
    "createSuccess": "Artefacto creada exitosamente",
    "updateSuccess": "Artefacto actualizada exitosamente",
    "deleteSuccess": "Artefacto eliminada exitosamente",
    "noArtifacts": "Aún no hay transformaciones",
  ...
  "models": {
    ...
    "defaultAssignmentsDesc": "Configura qué modelos usar para diferentes propósitos en Construction OS",
    "missingRequiredModels": "Faltan modelos requeridos: {models}. Construction OS puede no funcionar correctamente sin estos.",
    ...
    "artifactModelLabel": "Modelo de transformación",
    "artifactModelDesc": "Usado para resúmenes, análisis y transformaciones",
  ...
  "apiKeys": {
    ...
    "encryptionRequiredDescription": "Establece la variable de entorno CONSTRUCTION_OS_ENCRYPTION_KEY con cualquier cadena secreta para habilitar el almacenamiento de claves API en la base de datos.",
