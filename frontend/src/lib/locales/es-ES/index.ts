export const esES = {
  ...
  "projects": {
    ...
    "deleteProjectNotes": "{count} nota(s) serán eliminadas permanentemente.",
    "deleteProjectNoNotes": "No hay notas que eliminar.",
  ...
  "sources": {
    ...
    "cannotSaveNoteNoProject": "No se puede guardar la nota: ID de cuaderno no disponible",
