...
> - **[docker-compose-speaches.yml](../../examples/docker-compose-speaches.yml)** - Speaches + Construction OS
...
### Step 4: Configure Construction OS
...
```yaml
# In your Construction OS docker-compose.yml
environment:
...
### Step 5: Add Model in Construction OS
...
### Construction OS in Docker (macOS/Windows)

**STT Base URL:** `http://host.docker.internal:8969/v1`

### Construction OS in Docker (Linux)
...
# From inside Construction OS container
docker exec -it construction-os curl http://host.docker.internal:8969/v1/models
```
