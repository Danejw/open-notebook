...
Get Construction OS running locally in 5 minutes.
...
- **Frontend**: http://localhost:3000 → Construction OS UI
...
- **First Issue?** Pick a [good first issue](https://github.com/lfnovo/construction-os/issues?q=label%3A%22good+first+issue%22)
