...
import { DefaultPromptEditor } from '@/app/(dashboard)/artifacts/components/DefaultPromptEditor'
import { ArtifactsList } from '@/app/(dashboard)/artifacts/components/ArtifactsList'
import { ArtifactPlayground } from '@/app/(dashboard)/artifacts/components/ArtifactPlayground'
