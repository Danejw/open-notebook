export const zhCN = {
  ...
  sources: {
    ...
    noInsightsYet: "暂无见解",
    createFirstInsight: "使用上方的工件规则创建您的第一个见解",
    viewInsight: "查看见解",
    deleteInsight: "删除见解",
  ...
  apiKeys: {
    ...
    description: "将 API 密钥安全地存储在数据库中，以在 Construction OS 中启用 AI 服务商。",
