"""
Unit tests for the construction_os.utils module.
...
from construction_os.utils import (
...
class TestVersionUtilities:
    ...
    def test_get_version_from_github_invalid_url(self):
        ...
        from construction_os.utils.version_utils import get_version_from_github
