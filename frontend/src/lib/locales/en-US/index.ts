export const enUS = {
  ...
  skills: {
    ...
    empty: "No skills yet",
    emptyDesc: "Create a skill or upload a ZIP package to get started.",
    uploadZip: "Upload ZIP",
    importTitle: "Import Skill ZIP",
    importDesc: "Upload a skill package, review the files, then confirm to save.",
