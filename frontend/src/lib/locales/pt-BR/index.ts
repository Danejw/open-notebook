export const ptBR = {
  ...
  "sources": {
    ...
    "selectArtifact": "Selecione uma transformação...",
    ...
    "artifactInsightQueued": "Modelo enfileirado para esta fonte",
  ...
  "artifacts": {
    "title": "Artefatos",
    "desc": "Artefatos são prompts que serão usados pelo LLM para processar uma fonte e extrair insights, resumos, etc.",
  ...
  "models": {
    ...
    "artifactModelDesc": "Usado para resumos, insights e transformações",
