...
Related docs: [components.md](./components.md) (what exists) · [agent-catalog.md](./agent-catalog.md) (prompt contract)
...
2. `docs/a2ui/agent-catalog.md`
3. `docs/a2ui/components.md`
