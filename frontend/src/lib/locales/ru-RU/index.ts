...
export const ruRU = {
  ...
  "common": {
    ...
    "saveToNote": "Сохранить в артефакт",
  ...
  "projects": {
    ...
    "deleteProjectNotes": "Будет удалено артефактов: {count}.",
    "deleteProjectNoNotes": "Нет артефактов для удаления.",
    ...
    "artifactCreatedSuccess": "Артефакт успешно создан",
    "failedToCreateArtifact": "Не удалось создать артефакт",
    "artifactUpdatedSuccess": "Артефакт успешно обновлён",
    "failedToUpdateArtifact": "Не удалось обновить артефакт",
    "artifactDeletedSuccess": "Артефакт успешно удалён",
    "failedToDeleteArtifact": "Не удалось удалить артефакт",
    "noteCreatedSuccess": "Артефакт успешно создан",
    "failedToCreateNote": "Не удалось создать артефакт",
    "noteUpdatedSuccess": "Артефакт успешно обновлён",
    "failedToUpdateNote": "Не удалось обновить артефакт",
    "noteDeletedSuccess": "Артефакт успешно удалён",
    "failedToDeleteNote": "Не удалось удалить артефакт",
  ...
  "sources": {
    ...
    "cannotSaveNoteNoProject": "Невозможно сохранить артефакт: ID проекта недоступен",
    ...
    "editNote": "Редактировать артефакт",
    "createNote": "Создать артефакт",
    "addTitle": "Добавьте название...",
    "untitledNote": "Артефакт без названия",
    "writeNotePlaceholder": "Напишите содержимое артефакта здесь...",
    "saveNote": "Сохранить артефакт",
    "createNoteBtn": "Создать артефакт",
    "urlLabel": "URL(ы) *",
    "fileLabel": "Файл(ы) *",
  ...
  "chat": {
    "contextNoneSelected": "Контекст не выбран — переключите источники или артефакты, чтобы включить их.",
    "contextSearchPoolHelp": "Выбранные источники/артефакты ищутся при каждом сообщении. Чат загружает только наиболее релевантные фрагменты каждый раз.",
    "contextFullSources": "{count} полных источника/источников",
    "contextFullArtifacts": "{count} полных артефакта/артефактов",
    "send": "Send",
    "queue": "Message queue",
  ...
  "podcasts": {
    ...
    "content": "Контент",
    "contentDesc": "Выберите проекты, источники и артефакты для включения в этот эпизод.",
    ...
    "addContextDesc": "Выберите хотя бы один источник или артефакт для включения в эпизод.",
    ...
    "noNotes": "В этом проекте нет доступных артефактов.",
  ...
  "artifacts": {
    "title": "Артефакты",
    "desc": "Артефакты — это промпты, которые LLM использует для обработки источника и извлечения резюме, структурированных результатов и т.д.",
    ...
    "promptHint": "Промпты должны учитывать содержимое источника. Вы можете попросить модель резюмировать, извлечь ключевые пункты или создать структурированный вывод, например таблицы.",
  ...
  "models": {
    ...
    "artifactModelDesc": "Используется для резюме, структурированных извлечений и артефактов",
