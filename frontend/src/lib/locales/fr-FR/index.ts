export const frFR = {
  ...
  "projects": {
    ...
    "deleteProjectNotes": "{count} note(s) seront supprimées définitivement.",
    "deleteProjectNoNotes": "Aucune note à supprimer.",
  ...
  "sources": {
    ...
    "cannotSaveNoteNoProject": "Impossible d'enregistrer la note : ID du projet non disponible",
  ...
  "podcasts": {
    ...
    "content": "Contenu",
    "contentDesc": "Choisissez les projets, sources et notes à inclure dans cet épisode.",
    ...
    "noNotes": "Aucune note disponible dans ce projet.",
