export const esES = {
  ...
  projects: {
    ...
    deleteProjectLoading: "Cargando vista previa de eliminación...",
  ...
  sources: {
    ...
    manageProjectsDesc: "Gestiona qué cuadernos contienen esta fuente",
  ...
  apiKeys: {
    ...
    description: "Almacena claves API de forma segura en la base de datos para habilitar proveedores de IA en Construction OS.",
