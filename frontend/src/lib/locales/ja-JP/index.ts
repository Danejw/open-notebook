export const jaJP = {
  ...
  "apiErrors": {
    ...
    "artifactNotFound": "トランスフォーメーションが見つかりません",
  ...
  "connectionErrors": {
    ...
    "apiDesc": "Construction OS APIサーバーに到達できませんでした",
  ...
  "navigation": {
    ...
    "podcasts": "ポッドキャスト",
    "models": "モデル",
    "artifacts": "アーティファクトテンプレート",
    "images": "Images",
    "templates": "Templates",
    "skills": "Skills",
    "tools": "Tools",
    "artifact": "トランスフォーメーション",
    "settings": "設定",
    "advanced": "詳細設定",
    "nav": "ナビゲーション",
    "language": "言語を切り替え",
  ...
  "projects": {
    ...
    "deleteProjectDesc": "\"{name}\" を削除しますか？この操作は元に戻せません。",
    "deleteProjectNotes": "{count} 件のアーティファクトが完全に削除されます。",
    "deleteProjectNoNotes": "削除するアーティファクトはありません。",
    "deleteProjectExclusiveSources": "{count}件のソースはこのプロジェクトにのみ存在します。",
    "deleteProjectSharedSources": "{count}件のソースは他のプロジェクトと共有されており、リンクが解除されます。",
    ...
    "notFoundDesc": "指定されたプロジェクトは存在しません。",
    "updated": "更新日時",
    ...
    "exportPdfSuccess": "アーティファクトを PDF としてエクスポートしました",
    "exportMarkdownSuccess": "アーティファクトを Markdown としてエクスポートしました",
    "failedToExportPdf": "PDF のエクスポートに失敗しました",
    "failedToExportMarkdown": "Markdown のエクスポートに失敗しました",
    "artifactCreatedSuccess": "アーティファクトを作成しました",
    "failedToCreateArtifact": "アーティファクトの作成に失敗しました",
    "artifactUpdatedSuccess": "アーティファクトを更新しました",
    "failedToUpdateArtifact": "アーティファクトの更新に失敗しました",
    "artifactDeletedSuccess": "アーティファクトを削除しました",
    "failedToDeleteArtifact": "アーティファクトの削除に失敗しました",
    "noteCreatedSuccess": "アーティファクトを作成しました",
    "failedToCreateNote": "アーティファクトの作成に失敗しました",
    "noteUpdatedSuccess": "アーティファクトを更新しました",
    "failedToUpdateNote": "アーティファクトの更新に失敗しました",
    "noteDeletedSuccess": "アーティファクトを削除しました",
    "failedToDeleteNote": "アーティファクトの削除に失敗しました",
    "createNew": "新規プロジェクトを作成",
    "descPlaceholder": "このプロジェクトについての情報を追加...",
  ...
  "sources": {
    ...
    "cannotSaveNoteNoProject": "アーティファクトを保存できません：プロジェクト ID が利用できません",
    ...
    "sourcesAddedToProject": "{count}件のソースをプロジェクトに追加しました",
    "failedToAddSourcesToProject": "プロジェクトへのソース追加に失敗しました",
    "partialAddSuccess": "{success}件追加成功、{failed}件失敗",
    "sourceRemovedFromProject": "プロジェクトからソースを削除しました",
    "failedToRemoveSourceFromProject": "プロジェクトからのソース削除に失敗しました",
    "removeConfirm": "プロジェクトからこのソースを削除しますか？",
    "checking": "確認中...",
    ...
    "preparing": "準備中...",
    "dropArtifactHint": "新しいソースを追加するには、ここにテンプレートをドロップ",
    "dropArtifactNoteHint": "ソースとして取り込むには、ここにアーティファクトをドロップ",
    "dropArtifactOnSource": "このソースでテンプレートを実行するにはドロップ",
    "dragTemplateToSource": "または Artifacts からソースにテンプレートをドラッグしてください。",
    "editNote": "アーティファクトを編集",
    "createNote": "アーティファクトを作成",
    "addTitle": "タイトルを追加...",
    "untitledNote": "無題のアーティファクト",
    "writeNotePlaceholder": "アーティファクトの内容をここに入力...",
    "saveNote": "アーティファクトを保存",
    "createNoteBtn": "アーティファクトを作成",
    "urlLabel": "URL *",
    "fileLabel": "ファイル *",
    ...
    "htmlDetected": "HTMLコンテンツが検出されました。処理後にMarkdownにアーティファクトされます。",
    "titlePlaceholder": "ソースにわかりやすいタイトルを付けてください",
    "batchTitlesAuto": "タイトルは各ソースごとに自動生成されます。",
    "batchCommonSettings": "同じプロジェクトとトランスフォーメーションがすべてのアイテムに適用されます。",
    ...
    "deleteSource": "ソースを削除",
    "retry": "再試行",
    "failureDetailsUnavailable": "この以前のエラーの診断詳細は利用できません。",
    "addExistingTitle": "既存ソースを追加",
    "addExistingDesc": "すべてのプロジェクトから既存のソースを選択して現在のプロジェクトに追加します。",
  ...
  "chat": {
    "contextNoneSelected": "コンテキストが選択されていません — ソースまたはアーティファクトを切り替えて含めてください。",
    "contextSearchPoolHelp": "選択したソース/アーティファクトはメッセージごとに検索されます。チャットは毎回最も関連性の高い抜粋のみを読み込みます。",
    "contextFullSources": "完全なソース {count} 件",
    "contextFullArtifacts": "完全なアーティファクト {count} 件",
    "send": "Send",
    "queue": "Message queue",
    ...
    "chatWithProject": "プロジェクトとチャット",
    "unableToLoadChat": "チャットを読み込めません",
    "startByCreating": "最初のプロジェクトを作成してリサーチを整理しましょう。",
  ...
  "searchPage": {
    ...
    "searchNotes": "アーティファクトを検索",
    "resultsFound": "{count}件の結果",
    "matches": "一致（{count}件）",
    "noResultsFor": "「{query}」に一致する結果がありません",
    "notSet": "未設定",
    "saveToProject": "プロジェクトに保存",
    "saveSuccess": "プロジェクトに保存しました",
    "saveError": "プロジェクトへの保存に失敗しました",
  ...
  "podcasts": {
    ...
    "content": "コンテンツ",
    "contentDesc": "このエピソードに含めるプロジェクト、ソース、アーティファクトを選択してください。",
    "itemsSelected": "{count}件選択中",
    "tokens": "{count}トークン",
    "chars": "{count}文字",
    "loadingProjects": "プロジェクトを読み込み中...",
    "noProjectsFoundInPodcasts": "プロジェクトが見つかりません。ポッドキャストを生成する前にプロジェクトを作成してコンテンツを追加してください。",
    ...
    "addContextDesc": "エピソードに含めるソースまたはアーティファクトを少なくとも1つ選択してください。",
    "generationFailed": "ポッドキャスト生成に失敗しました",
    "speakerProfile": "スピーカープロファイル",
    "usesSpeakerProfile": "スピーカープロファイルを使用",
    "sources": "ソース",
    "notes": "アーティファクト",
    "noSources": "このプロジェクトにはソースがありません。",
    "noNotes": "このプロジェクトにはアーティファクトがありません。",
    "selectMode": "モードを選択",
    ...
    "noEpisodesYet": "ポッドキャストエピソードがまだありません。プロジェクトまたはソースのチャットインターフェースから最初のエピソードを生成してください。",
  ...
  "settings": {
    ...
    "filesHelp": "ファイルがアップロードされて処理されると、ファイル自体は不要になります。ほとんどのユーザーはConstruction OSがアップロードフォルダから自動的にファイルを削除することを許可すべきです。",
  ...
  "advanced": {
    ...
    "updateAvailableDesc": "Construction OSの新しいバージョンが利用可能です。",
    "upToDate": "最新版です",
    "unknown": "不明",
  ...
  "artifacts": {
    "title": "トランスフォーメーション",
    "desc": "トランスフォーメーションはLLMがソースを処理して要約や構造化出力などを抽出するためのプロンプトです。",
    "playground": "プレイグラウンド",
    ...
    "createNew": "新規作成",
    "inputLabel": "入力テキスト",
    "inputPlaceholder": "アーティファクトするテキストを入力...",
    "outputLabel": "出力",
    ...
    "promptHint": "プロンプトはソースコンテンツを念頭に置いて書いてください。モデルに要約、要点の抽出、テーブルなどの構造化出力の生成を依頼できます。",
    "createSuccess": "トランスフォーメーションを作成しました",
    "updateSuccess": "トランスフォーメーションを更新しました",
    "deleteSuccess": "トランスフォーメーションを削除しました",
    "noArtifacts": "トランスフォーメーションがまだありません",
  ...
  "models": {
    ...
    "defaultAssignmentsDesc": "Construction OS全体で異なる目的に使用するモデルを設定",
    "missingRequiredModels": "必須モデルがありません: {models}。これらがないとConstruction OSが正しく機能しない可能性があります。",
    "selectModelPlaceholder": "モデルを選択",
    "requiredModelPlaceholder": "⚠️ 必須 - モデルを選択",
    "chatModelLabel": "チャットモデル",
    "chatModelDesc": "チャット会話に使用",
    "artifactModelLabel": "トランスフォーメーションモデル",
    "artifactModelDesc": "要約、構造化抽出、トランスフォーメーションに使用",
  ...
  "apiKeys": {
    ...
    "encryptionRequiredDescription": "CONSTRUCTION_OS_ENCRYPTION_KEY 環境変数に任意の秘密文字列を設定して、データベースへのAPIキーの保存を有効にしてください。",
    "configured": "設定済み",
    "notConfigured": "未設定",
