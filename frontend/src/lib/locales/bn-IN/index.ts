export const bnIN = {
  ...
  "projects": {
    ...
    "deleteProjectNotes": "{count}টি নোট চিরতরে মুছে যাবে।",
    "deleteProjectNoNotes": "মুছার জন্য কোন নোট নেই।",
  ...
  "sources": {
    ...
    "cannotSaveNoteNoProject": "নোট সংরক্ষণ করতে পারা যায়নি: প্রকল্প ID উপলব্ধ নয়",
  ...
  "podcasts": {
    ...
    "content": "কন্টেন্ট",
    "contentDesc": "এই এপিসোডে অন্তর্ভুক্ত করতে প্রকল্প, উৎস এবং নোট বেছে নিন।",
    ...
    "noNotes": "এই প্রকল্পে কোন নোট উপলব্ধ নয়।",
