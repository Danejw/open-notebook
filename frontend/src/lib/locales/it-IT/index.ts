export const itIT = {
  ...
  "projects": {
    ...
    "deleteProjectNotes": "{count} nota/e verranno eliminate definitivamente.",
    "deleteProjectNoNotes": "Nessuna nota da eliminare.",
  ...
  "sources": {
    ...
    "cannotSaveNoteNoProject": "Impossibile salvare la nota: ID quaderno non disponibile",
