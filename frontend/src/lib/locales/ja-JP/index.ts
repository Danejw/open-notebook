export const jaJP = {
  ...
  "projects": {
    ...
    "deleteProjectNotes": "{count}件のノートが完全に削除されます。",
    "deleteProjectNoNotes": "削除するノートはありません。",
  ...
  "sources": {
    ...
    "cannotSaveNoteNoProject": "ノートを保存できません：プロジェクトIDが利用できません",
  ...
  "podcasts": {
    ...
    "content": "コンテンツ",
    "contentDesc": "このエピソードに含めるプロジェクト、ソース、ノートを選択してください。",
