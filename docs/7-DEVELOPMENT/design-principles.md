...
This document outlines the core principles, vision, and design philosophy that guide Construction OS's development. All contributors should read and understand these principles before proposing changes or new features.

## 🎯 Project Vision

Construction OS aims to be a **privacy-focused, self-hosted alternative to Google Notebook LM** that empowers users to:
...
**In Practice**:
- Plugin systems for artifacts and commands
