export const ptBR = {
  ...
  "projects": {
    ...
    "deleteProjectNotes": "{count} nota(s) serão permanentemente excluídas.",
    "deleteProjectNoNotes": "Nenhuma nota para excluir.",
  ...
  "sources": {
    ...
    "cannotSaveNoteNoProject": "Não é possível salvar nota: ID do caderno não disponível",
