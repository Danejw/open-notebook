...
class PasswordAuthMiddleware(BaseHTTPMiddleware):
    ...
    Always active with default password if CONSTRUCTION_OS_PASSWORD is not set.
    Supports Docker secrets via CONSTRUCTION_OS_PASSWORD_FILE.
    Legacy fallback: OPEN_NOTEBOOK_PASSWORD / OPEN_NOTEBOOK_PASSWORD_FILE.
    """

    def __init__(self, app, excluded_paths: Optional[list] = None):
        super().__init__(app)
        self.password = get_secret_from_env("CONSTRUCTION_OS_PASSWORD")
...
def check_api_password(
    ...
    Supports Docker secrets via CONSTRUCTION_OS_PASSWORD_FILE.
    Returns True without checking credentials if CONSTRUCTION_OS_PASSWORD is not configured.
