    ...
    <Tooltip>
      ...
      <TooltipContent side="right" className="max-w-xs">
        ...
        <p className="text-[10px] opacity-80">
          {t('opportunities.railTooltipMeta')
            .replace('{status}', pipelineStatusLabel(t, opportunity))
            .replace('{dueDate}', formatShortDate(t, opportunity.bid_due_at))}
        </p>
      </TooltipContent>
    </Tooltip>
  )
...
export function OpportunityRow({
  ...
  const due = formatShortDate(t, opportunity.bid_due_at)
