export const bnIN = {
  ...
  projects: {
    ...
    deleteProjectLoading: "মুছে ফেলার প্রিভিউ লোড হচ্ছে...",
  ...
  sources: {
    ...
    manageProjectsDesc: "এই উৎস কোন প্রকল্পে রয়েছে তা পরিচালনা করুন",
  ...
  apiKeys: {
    ...
    description: "Construction OS এ AI প্রোভাইডার সক্ষম করতে ডেটাবেসে নিরাপদভাবে API কী সংরক্ষণ করুন।",
